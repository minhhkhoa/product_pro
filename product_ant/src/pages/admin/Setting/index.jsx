...
function Setting() {
    ...
    },
    {
      ...
      message:
        language === "en"
          ...
          : "Cập nhật ứng dụng phiên bản mới",
      type: "success",
    },
  ];
  ...
  const activityData = [
    {
      id: 1,
      activity:
        language === "en" ? "Logged into the system" : "Đăng nhập vào hệ thống",
      date: "10/02/2025",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      activity: language === "en" ? "Changed password" : "Đổi mật khẩu",
      date: "08/02/2025",
    },
  ];
  ...
  const handleThemeChange = (value) => {
    ...
    message.success(
      `${
        language === "en"
          ? "Theme changed to"
          : "Chế độ giao diện được đổi thành"
      } ${value}`
    );
  };
  ...
  const handleUpload = (file) => {
    ...
    message.success(
      language === "en" ? "Avatar updated" : "Ảnh đại diện đã được cập nhật"
    );
    return false;
  };
  ...
  return (
    <Layout className={darkMode ? "dark-mode" : "light-mode"}>
      <Content style={{ padding: "20px" }}>
        ...
        {/* Dark Mode */}
        <Card
          title={language === "en" ? "Theme Mode" : "Chế độ Giao Diện"}
          style={{ marginBottom: "20px" }}
        >
          <p>
            {language === "en"
              ? "Choose your theme mode:"
              : "Chọn chế độ giao diện của bạn:"}
          </p>
        ...
        <Card
          title={language === "en" ? "Customization" : "Tùy Chỉnh Giao Diện"}
          style={{ marginBottom: "20px" }}
        >
          <p>
            {language === "en" ? "Choose theme:" : "Chọn chủ đề giao diện:"}
          </p>
          <Select
          ...
          >
            <Select.Option value="Light">
              {language === "en" ? "Light" : "Sáng"}
            </Select.Option>
            <Select.Option value="Dark">
              {language === "en" ? "Dark" : "Tối"}
            </Select.Option>
          </Select>
        ...
        <Card
          title={
            language === "en" ? "Notification Updates" : "Thông Báo Cập Nhật"
          }
          style={{ marginBottom: "20px" }}
        >
          <List
        ...
        {/* App Management */}
        <Card
          title={language === "en" ? "App Management" : "Quản lý Ứng Dụng"}
          style={{ marginBottom: "20px" }}
        >
          <Button
            type="primary"
        ...
        {/* Avatar Management */}
        <Card
          title={language === "en" ? "Avatar" : "Ảnh Đại Diện"}
          style={{ marginBottom: "20px" }}
        >
          <Upload
        ...
        {/* Security Settings */}
        <Card
          title={language === "en" ? "Security Settings" : "Cài Đặt Bảo Mật"}
          style={{ marginBottom: "20px" }}
        >
          <p>
            {language === "en"
              ? "Manage your access permissions:"
              : "Quản lý quyền truy cập của bạn:"}
          </p>
          <Button
        ...
        <Card
          title={
            language === "en" ? "Connected Devices" : "Thiết Bị Đã Kết Nối"
          }
          style={{ marginBottom: "20px" }}
        >
          <p>
            {language === "en"
              ? "Your connected devices list:"
              : "Danh sách thiết bị đã kết nối của bạn:"}
          </p>
          <List
        ...
        {/* Activity Log */}
        <Card
          title={language === "en" ? "Activity Log" : "Nhật Ký Hoạt Động"}
          style={{ marginBottom: "20px" }}
        >
          <List
            ...
            renderItem={(item) => (
              <List.Item>
                <Typography.Text strong>{item.activity}</Typography.Text> -{" "}
